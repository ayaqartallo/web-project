...
<head>
    <meta charset="UTF-8">
    <title>RAMALLAH & TAYBEH FULL DAY TOUR (Private Tour)</title>
...
<section class="sec1">
    <table>
        <tr>
            <td><img src="imgs/unnamed.png" alt="" style="height: 40px; width: 170px"></td>
...
<h2 style="padding-left: 100px">RAMALLAH & TAYBEH FULL DAY TOUR (Private Tour)</h2>
<table>
    <tr>
        <td style="padding-left: 100px">
            <div class="slideshow-container">
                ...
                <div class="mySlides fade">
                    <img src="imgs/Ramallah-3-min-min.jpg" style="width:300px; height: 300px">
                </div>
                ...
                <div class="mySlides fade">
                    <img src="imgs/MG_3951-e1548959969755-500x334.jpg" style="width:300px; height: 300px">
                </div>
        ...
        <td style="padding-left: 100px">
            <div>RAMALLAH & TAYBEH FULL DAY TOUR (Private Tour) <br>$75.00 per person <br><br></div>
            <div style="font-size: small">When: Every Saturday <br>Time: 10:00 am
