...
<head>
    <meta charset="UTF-8">
    <title>BETHLEHEM FULL DAY TOUR</title>
...
<h2 style="padding-left: 100px">BETHLEHEM FULL DAY TOUR</h2>
<table>
    <tr>
        ...
        <td style="padding-left: 100px">
            <div>BETHLEHEM FULL DAY TOUR <br>$75.00 per person <br><br></div>
            <div style="font-size: small">TimeTo be determined . If you want a tour within the next 24-48 hours, please contact us directly by phone or email.
                ...
                <br>Starting Point:Visit Palestine Center, Bethlehem  <br>Location:   Opposite the Bethlehem City Mall (central bus station) Up the stairs next to the Canal Souvenir shop).<br><br></div>
            <div>
                <form action="">
