...
<head>
    <meta charset="UTF-8">
    <title>JERUSALEM FULL DAY TOUR (MT. OF OLIVES AND OLD CITY)</title>
...
<h2 style="padding-left: 100px">JERUSALEM FULL DAY TOUR (MT. OF OLIVES AND OLD CITY)</h2>
<table>
    <tr>
        <td style="padding-left: 100px">
            <div class="slideshow-container">
                ...
                <div class="mySlides fade">
                    <img src="imgs/oli-500x316.jpg" style="width:300px; height: 300px">
                </div>

                <div class="mySlides fade">
                    <img src="imgs/agenda-1-min-500x375.jpg" style="width:300px; height: 300px">
                </div>

                <div class="mySlides fade">
                    <img src="imgs/roof-min.jpg" style="width:300px; height: 300px">
                </div>
        ...
        <td style="padding-left: 100px">
            <div>JERUSALEM FULL DAY TOUR (MT. OF OLIVES AND OLD CITY) <br>$75.00 per person <br><br></div>
            <div style="font-size: small">When: Private Tour <br>Time: 9:00 am
                <br>Duration:  Approximately 6-7 hours

                <br>Language: English (other languages available for private tours)

                <br>Starting Point: Jerusalem Hotel <br>Location: 15 Antara Ben Shadad St., Jerusalem off the corner of Nablus road<br><br></div>
            <div>
                <form action="">
