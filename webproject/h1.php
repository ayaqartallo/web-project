...
<head>
    <meta charset="UTF-8">
    <title>HEBRON AND BETHLEHEM FULL DAY TOUR (Private Tour)</title>
...
<h2 style="padding-left: 100px">HEBRON AND BETHLEHEM FULL DAY TOUR (Private Tour)</h2>
<table>
    <tr>
        <td style="padding-left: 100px">
            <div class="slideshow-container">
                ...
                <div class="mySlides fade">
                    <img src="imgs/Hebron-2-500x374.jpg" style="width:300px; height: 300px">
                </div>

                <div class="mySlides fade">
                    <img src="imgs/Hebron-4-500x333.jpg" style="width:300px; height: 300px">
                </div>

                <div class="mySlides fade">
                    <img src="imgs/Old-Market-Hebron-500x332.jpg" style="width:300px; height: 300px">
                </div>

                <div class="mySlides fade">
                    <img src="imgs/hebron.jpg" style="width:300px; height: 300px">
                </div>
                <div class="mySlides fade">
        ...
        <td style="padding-left: 100px">
            <div>HEBRON AND BETHLEHEM FULL DAY TOUR (Private Tour) <br>$90.00 per person <br></div>
            <br> Time : 9:00 am -5:00 pm .  If you want a tour within the next 24-48 hours, please contact us directly by phone or email.
            <br> Duration: Approximately 7-8 hours.
            <br> Language : English (other languages available for private tours).

            <br>Starting Point:Visit Palestine Center, Bethlehem.
            <br> location: Opposite the Bethlehem City Mall (central bus station) Up the stairs next to the Canal Souvenir shop). <br><br></div>
            <div>
                <form action="">
