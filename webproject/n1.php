...
<head>
    <meta charset="UTF-8">
    <title>NABLUS & SEBASTIYA FULL TOUR (Private Tour)</title>
...
<h2 style="padding-left: 100px">NABLUS & SEBASTIYA FULL TOUR (Private Tour)</h2>
<table>
    <tr>
        <td style="padding-left: 100px">
            <div class="slideshow-container">
                ...
                <div class="mySlides fade">
                    <img src="imgs/Yahya_Mosque_Sebastiya1-500x376.jpg" style="width:300px; height: 300px">
                </div>

                <div class="mySlides fade">
                    <img src="imgs/Great_Mosque_Nablus-500x434.jpg" style="width:300px; height: 300px">
                </div>

                <div class="mySlides fade">
                    <img src="imgs/bt-500x321.png" style="width:300px; height: 300px">
                </div>

                <div class="mySlides fade">
                    <img src="imgs/PDT-02-1-500x375.png" style="width:300px; height: 300px">
                </div>
                <div class="mySlides fade">
                    <img src="imgs/Great_Mosque_Nablus-500x434.jpg" style="width:300px; height: 300px">
                </div>
        ...
        <td style="padding-left: 100px">
            <div>NABLUS & SEBASTIYA FULL TOUR (Private Tour) <br>$95.00 per person <br><br></div>
            <div style="font-size: small">Time: 9:00 am
                <br>Duration: Approximately 7-8 hours

                <br>Language: English (other languages available for private tours)

                <br>Starting Point:Nablus <br>Location: 15 Antara Ben Shadad St., Jerusalem off the corner of Nablus road

                <br>Ending Point:  Al-Shuhada roundabout (Next to the Arab Bank)<br><br></div>
            <div>
                <form action="">
