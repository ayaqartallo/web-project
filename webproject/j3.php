...
<head>
    <meta charset="UTF-8">
    <title>JERUSALEM FULL DAY TOUR (OLD CITY)</title>
...
<h2 style="padding-left: 100px">JERUSALEM FULL DAY TOUR (OLD CITY)</h2>
<table>
    <tr>
        ...
        <td style="padding-left: 100px">
            <div>JERUSALEM FULL DAY TOUR (OLD CITY) <br>$70.00 per person <br><br></div>
            <div style="font-size: small"> When: Private Tour <br>Time:  9:00 am – 3:00 pm
                <br>Duration: Approximately 6 hours

                <br>Language: English (other languages available for private tours)

                <br>Starting Point: Depends on your location <br><br></div>
            <div>
                <form action="">
