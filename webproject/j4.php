...
<head>
    <meta charset="UTF-8">
    <title>JERUSALEM MOSAICS TOUR (Private)</title>
...
<h2 style="padding-left: 100px">JERUSALEM MOSAICS TOUR (Private)</h2>
<table>
    <tr>
        ...
        <td style="padding-left: 100px">
            <div>JERUSALEM MOSAICS TOUR (Private) <br>$50.00 per person <br><br></div>
            <div style="font-size: small"> When: Private Tour <br>Time: 9:30 am
                <br>Duration: Approximately 4.5 hours

                <br>Language: English (other languages available for private tours)

                <br>Starting Point:  To be determined.  <br><br></div>
            <div>
                <form action="">
