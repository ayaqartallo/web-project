...
<head>
    <meta charset="UTF-8">
    <title>Bethlehem Old Quarter Tour (Private Tour)</title>
...
<h2 style="padding-left: 100px">Bethlehem Old Quarter Tour (Private Tour)</h2>
<table>
    <tr>
        ...
        <td style="padding-left: 100px">
            <div>Bethlehem Old Quarter Tour (Private Tour) <br>$35.00 per person <br><br></div>
            <div style="font-size: small"> Time :  To be determined.
                <br>Duration: Approximately 2.5 hours.

                <br>Language: English (other languages available for private tours).

                <br>Starting Point:Visit Palestine Center, Bethlehem  <br>
                Location:   Opposite the Bethlehem City Mall (central bus station) Up the stairs next to the Canal Souvenir shop).<br><br></div>
            <div>
                <form action="">
