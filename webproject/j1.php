...
<head>
    <meta charset="UTF-8">
    <title>JERUSALEM AND BETHLEHEM FULL DAY TOUR (Private Tour)</title>
...
<h2 style="padding-left: 100px">JERUSALEM AND BETHLEHEM FULL DAY TOUR (Private Tour)</h2>
<table>
    <tr>
        ...
        <td style="padding-left: 100px">
            <div>JERUSALEM AND BETHLEHEM FULL DAY TOUR (Private Tour) <br>$75.00 per person <br><br></div>
            <div style="font-size: small">Time: 9:00 am
                ...
                <br>Starting Point: Jerusalem Hotel <br>Location: 15 Antara Ben Shadad St., Jerusalem off the corner of Nablus road

                <br>Ending Point:  Tour ends in Bethlehem <br><br></div>
            <div>
                <form action="">
