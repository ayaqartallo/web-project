...
<head>
    <meta charset="UTF-8">
    <title>BETHLEHEM OVERNIGHT PACKAGE (2 NIGHTS / 3 DAYS)</title>
...
<h2 style="padding-left: 100px">BETHLEHEM OVERNIGHT PACKAGE (2 NIGHTS / 3 DAYS)</h2>
<table>
    <tr>
        ...
        <td style="padding-left: 100px">
            <div>BETHLEHEM OVERNIGHT PACKAGE (2 NIGHTS / 3 DAYS) <br>$290.00 per person <br><br></div>


            <br>Language:  English (other languages are available for private tours including Spanish, Italian, Spanish, German, Arabic and more).

            <br>Starting Point:Visit Palestine Center, Bethlehem  <br>
            Location:   Opposite the Bethlehem City Mall (central bus station)
