...
<head>
    <meta charset="UTF-8">
    <title>Jericho – Walking the Oasis of Faith and Beauty (Private Tour)</title>
...
<h2 style="padding-left: 100px">Jericho – Walking the Oasis of Faith and Beauty (Private Tour)</h2>
<table>
    <tr>
        <td style="padding-left: 100px">
            <div class="slideshow-container">
                ...
                <div class="mySlides fade">
                    <img src="imgs/Picture37-min.png" style="width:300px; height: 300px">
                </div>

                <div class="mySlides fade">
                    <img src="imgs/Picture33-min.png" style="width:300px; height: 300px">
                </div>
        ...
        <td style="padding-left: 100px">
            <div>Jericho – Walking the Oasis of Faith and Beauty (Private Tour) <br>$65.00 per person <br></div>
            <br> Time :9:30 am – 1:30 pm
            <br> Duration: Approximately 4.5-5 hours.
            <br>Starting Point:Jericho Mosaic Center
            <br> location: Jericho Mosaic Center is located just before the Wadi Al-Qelt -Bridge, coming from Jerusalem or Bethlehem. <br><br></div>
            <div>
                <form action="">
